      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <li ><a href="usuarios.php"><span><img src="images/navicons/112.png"></span><span>Usuarios</span> </a></li>
            ...
            <li class="active"><a href="asignar.php">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Asignar cursos</h2>
            <form id="form" action="valiasignar.php" method="post" class="clearfix">

          <div class="row">
  <div class="col-xs-5">
     <label for="exampleInputEmail1">Alumno</label>
        <input type="text" name="usuarioalu" class="form-control formi" id="exampleInputEmail1" required="required" placeholder="Ingrese el nombre de usuario">
  </div>


  <div class="col-xs-5">
  <label for="exampleInputEmail1">Curso</label>
  <input type="text" name="curso" class="form-control formi" id="exampleInputText" required="required" placeholder="Ingrese el nombre del curso">


  </div>
  <div class="col-xs-2">
    <button type="submit" class="btn btn-default asignar ">Asignar</button>
  </div>
